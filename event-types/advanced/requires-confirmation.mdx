...
<CardGroup cols={2}>
  <Card title="Disable confirmation emails" icon="envelope" href="/event-types/advanced/disable-confirmation-emails">
    Fine-tune which emails go out once a booking is approved.
  </Card>
  <Card title="Disable rescheduling and cancelling" icon="lock" href="/event-types/advanced/disable-reschedule-cancel">
