...
description: "Protect your Cal ID calendar from spam bots and malicious scripts by adding a Cloudflare Turnstile captcha challenge to your public booking page."
icon: "shield-halved"
keywords: ["captcha", "spam protection", "bot protection", "recaptcha", "prevent spam bookings", "human verification"]
related: ["/event-types/booking-questions/verify-email", "/event-types/booking-questions/email-domains", "/event-types/booking-questions/disable-guests", "/event-types/booking-questions/pre-booking-questions"]
---

Add a captcha challenge to your public booking page to keep automated bots and malicious scripts from flooding your calendar with fake appointments.
...
<Info>
  Captcha is bot protection for your booking page: it verifies that a real person — not an automated script — is submitting the booking, so scrapers and bots can't snatch slots or fill your schedule with junk.
</Info>
