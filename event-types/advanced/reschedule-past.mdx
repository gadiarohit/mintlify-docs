...
keywords: ["reschedule past", "past bookings", "reschedule old booking", "reschedule expired", "move past meeting", "past events"]
related: ["/event-types/advanced/disable-reschedule-cancel", "/event-types/advanced/book-via-reschedule-link", "/event-types/advanced/lock-timezone", "/event-types/advanced/requires-confirmation"]
---
...
<CardGroup cols={2}>
  <Card title="Book through reschedule link" icon="calendar-plus" href="/event-types/advanced/book-via-reschedule-link">
    Let guests create a brand-new booking from a reschedule link after a cancellation.
  </Card>
  <Card title="Manage reschedule & cancel" icon="ban" href="/event-types/advanced/disable-reschedule-cancel">
